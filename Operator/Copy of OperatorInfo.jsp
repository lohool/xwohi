...
<TR>
	...
	<TD>
<ww:select name="allList" listKey="roleID" listValue="name" list="select.roles" value="vo.roles.roleID" size="7"  multiple="multiple" cssStyle="border:1pt solid #636563;font-size:9pt;width=100px" />
...
{                            
	...
	{ 
		myform["vo.roles.roleID"].value = myform["vo.roles.roleID"].value + ',' +selectedList.item(i).value; 
	} 
