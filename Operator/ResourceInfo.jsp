...
<%@ page import="com.lohool.jproject.xwohi.operator.po.*"  %>
...
<div align="center">
<ww:form name="form1" namespace="/Resource" action="ResourceModify" method="post" validate="true">
...
<%
ArrayList userTypes=Globals.getUserTypes();
