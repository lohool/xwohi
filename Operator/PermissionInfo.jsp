...
<html xmlns:ww="http://www.opensymphony.com/webwork/" xmlns:xwohi="http://www.lohool.com/wohi/">
   ...
   <body leftmargin="0" topmargin="0">
      <div class="page">
         ...
         <br />
         <div align="center">
            <ww:form action="PermissionModify" method="post" name="form1" namespace="/Permission" validate="true">
			<ww:hidden name="vo.id" />
               ...
               <table align="center" bgcolor="#E3E3E3" cellpadding="0" cellspacing="0" class="sort-table" id="input_table" width="500">
                  ...
                  <TR>
                     ...
                     <TD bgColor="#ffffff" width="60%">
                        <ww:select list="select.dataGroup" listKey="id" listValue="id" name="vo.dataGroup.id" value="vo.dataGroup.id" />
                     </TD>
                  </TR>
                  <TR>
