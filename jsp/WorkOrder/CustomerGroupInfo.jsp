...
<%@ taglib uri="/WEB-INF/xwohi.tld" prefix="xwohi" %>
      <div class="page">
            <ww:form action="CustomerGroupModify" method="post" name="form1" namespace="/CustomerGroup" validate="true" onsubmit="return ajaxDatagridSubmit(this,'CustomerGroup_list')">
