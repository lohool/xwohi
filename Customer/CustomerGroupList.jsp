   ...
   <body leftmargin="0" topmargin="0">
      <div class="page">
         <div id="pageTitle">
            <TABLE cellpadding="0" cellspacing="0" height="30" id="title-table" width="100%">
               <thead>
                  <TR>
                     <TD>
                        <span class="pageTitle-left"><xwohi:i18n text="CustomerGroup.list" />
                           <img height="13" src="/images/ico_arrow_title.gif" width="13" />
                        </span>
                        <span class="pageTitle-right">
                           <a href="/CustomerGroup/CustomerGroupInput.action">
                              <xwohi:i18n text="new" />
                           </a>
                        </span>
                     </TD>
         ...
         <div align="left" id="seachdiv" style="display:none">
            <ww:form action="CustomerGroupList" method="post" name="form1" namespace="/CustomerGroup" validate="true"><ww:hidden name="vo.id" />
               <ww:hidden name="page" />
      ...
      <input type="reset" value="<xwohi:i18n text="reset" />"></TD>
         ...
         <table cellspacing="0" class="sort-table" id="sort-table" width="100%">
            <thead>
               <tr>
                  <td><xwohi:i18n text="CustomerGroup.name" /></td>
                  <TD width="30">
            ...
            <tbody>
               <ww:iterator value="objList">
                  <TR>
                     <td><a href="/Customer/CustomerList.action?vo.group.id=<ww:property value="id"/>"><ww:property value="name"/></a></td>
