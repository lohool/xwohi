...
<div id="TopBar" class="panel" style="z-index:1000;position:absolute; left:0;top:0; width:100%;height:30px;"> 
	<div style=" height:30px;float:right"> 
		...
		<a href="#" class="menuBarButton"  onclick="openDialog('/Operator/OperatorList.action','Modal Dialog',true)" >内部模式对话框</a>
...
<div id="LeftMenu"  class="panel" style="display:block;position:absolute; padding:0px; left:0px;top:42px; z-index:1001; " >
...
<div id="MainPanel"  class="panel" style="position:absolute; left:200px;padding:0px; top:42px;z-index:0;background:transparent;">
	<div id="Taskbar" class="panel"  style="width:100%;height:30px;"> 
			<FONT SIZE="4" COLOR="#3399CC"><span id="hidenMenuButton" style="cursor:handle" onclick="hideMenu()">&lt;&lt;</span></FONT><a class="separator"> </a>
	</div>
...
<!--
	...
	-->
<div id="Toolbars" class="panel" style="width:100%;height:0px;position:absolute;z-index:1002;display:none">
<!--
