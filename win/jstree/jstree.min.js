 ...
 */
	...
	$.jstree.core.prototype = {
		...
		/**
		 * check if a new node can be added here
		 * @name can_create()
		 * @return {Boolean}
		 */
		can_create : function (o) {
			par = this.get_parent(o);
			return par === '0' || par === '#';
		},
		/**
		 ...
		 * @return {Boolean}
		 */
		can_delete : function (o) {
			return o.id !== '0';
		},
		/**
		 * check if this node can be modifed
		 * @name can_edit()
		 * @return {Boolean}
		 */
		can_edit : function (o) {
		...
		items : function (o) { // Could be an object directly
			return {
				...
				"remove" : {
					...
					"icon"				: false,
					"separator_after"	: false,
					"_disabled"			: !(this.can_delete(o)), //(this.check("delete_node", data.reference, this.get_parent(data.reference), "")),
					"label"				: "删除",
					"action"			: function (data) {
						var inst = $.jstree.reference(data.reference),
							obj = inst.get_node(data.reference);
		...
		this.bind = function () {
			...
			this.element
				...
				.on("click.jstree", ".jstree-wholerow", function (e) {
						...
						var tmp = $.Event('click', { metaKey : e.metaKey, ctrlKey : null, altKey :null, shiftKey : null });
